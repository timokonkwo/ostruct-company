                ...
                <div class="col-xl-10 col-lg-12 col-md-9">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block" style="background-image: url(assets/img/team-1.jpg); background-repeat: no-repeat; background-size: cover; background-position: center"></div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" id="userform" name="userlogin" onsubmit="return validate();" novalidate>
                                            <div class="form-group">
                                                <input type="email" class="form-control form-control-user" id="email" aria-describedby="emailHelp" name="email" autocomplete="off" placeholder="Enter Email Address...">
                                        ...
                                        <div class="text-center">
                                            <hr>
                                            <a href="#" class="btn btn-warning btn-block text-black-50 btn-user disabled">Forgot
                                                Password?</a>
                                        </div>
                                        <hr>
                                        <div class="text-center">
